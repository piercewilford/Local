...
function bootstrapwp_widgets_init() {
    ...
    register_sidebar(
        ...
        register_sidebar(
        array(
            'name'          => __('How To Page - Left', 'bootstrapwp'),
            'id'            => 'how-to-page-1',
            'description'   => __('Widget Area for The How-To Page Left Section', 'bootstrapwp'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
        ...
        register_sidebar(
        array(
            'name'          => __('How To Page - Middle', 'bootstrapwp'),
            'id'            => 'how-to-page-2',
            'description'   => __('Widget Area for The How-To Page Middle Section', 'bootstrapwp'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h3 class="widget-title">',
            'after_title'   => '</h3>',
        ...
        register_sidebar(
        array(
            'name'          => __('How To Page - Right', 'bootstrapwp'),
            'id'            => 'how-to-page-3',
            'description'   => __('Widget Area for The How-To Page Right Section', 'bootstrapwp'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h3 class="widget-title">',
            'after_title'   => '</h3>',
        ...
        array(
            ...
            'id'            => 'footer-left',
            'description'   => __('Widget Area for The Footer Left Section', 'bootstrapwp'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h4 class="widget-title">',
            'after_title'   => '</h4>',
        ...
        register_sidebar(
        array(
            'name'          => __('Footer Center', 'bootstrapwp'),
            'id'            => 'footer-center',
            'description'   => __('Widget Area for The Footer Center Section', 'bootstrapwp'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h4 class="widget-title">',
            'after_title'   => '</h4>',
        ...
        array(
            ...
            'id'            => 'footer-right',
            'description'   => __('Widget Area for The Footer Right Section', 'bootstrapwp'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h4 class="widget-title">',
            'after_title'   => '</h4>',
        ...
        register_sidebar(
        array(
            'name'          => __('Footer QuickLinks', 'bootstrapwp'),
            'id'            => 'footer-quick-links',
            'description'   => __('Quick Links for the Footer', 'bootstrapwp'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => "</div>",
            'before_title'  => '<h3 class="widget-title">',
            'after_title'   => '</h3>',
...
function my_nav_menu_profile_link($menu) {  
    if (!is_user_logged_in()){
         $profilelink = '<li><a href="<?php echo site_url(); ?>/ofatest/the-barn-landing">' . __('TheBarn™') . '</a></li>';
...
$text = $text.substr(the_excerpt(), 0,20);;
...
'name' => 'Fill Out Profile Widget',
'id' => 'profile-widget',
'description' => 'This widget area is for the "Fill Out Profile" modal on the how-to page',
'before_widget' => '<div id="%1$s" class="widget %2$s">',
'after_widget' => '</div>',
'before_title' => '<h2>',
'after_title' => '</h2>'
...
'id' => 'header-login',
'description' => 'This widget area is for the login form in the dropdown in the header',
'before_widget' => '<div id="%1$s" class="widget %2$s">',
'after_widget' => '</div>',
'before_title' => '<h2>',
'after_title' => '</h2>'

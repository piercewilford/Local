...
<header class="page-title">
        ...
        <a href="http://optionsforanimals.com/find-a-doctor-europe/?country=select"><button style="float:right;font-family:inherit" class="btn btn-primary">For European Map Click Here</button></a>
    </header>

    <a href="http://optionsforanimals.com/listings"><h4>Click here to view Doctors in list view</h4></a>

   <?php  $state_name = $_GET['state_name']; ?>

<iframe src="http://createaclickablemap.com/map.php?id=15108&online=true" width="1000" height="583" style="border: none;"></iframe>
...
<!-- <img id="float" class="span1" style="float:right;" src="http://skunkboxstudios.com/dev/wp-content/uploads/2013/07/bug-final.png" alt="bug"> -->
      ...
      <!-- <div class="row fluid"> -->
             <?php query_posts( array('post_type' => 'directory_listing', 'listing_category' => $state_name));
